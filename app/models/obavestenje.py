...
AKCIJA_IDEA = "IDEA"
AKCIJA_URL = "URL"
# IDEA_CYCLE: RESURS_ID = PULS_IDEA_CIKLUSI.ID (sistemsko obavestenje o aktivaciji/
# isteku ciklusa ideja). Isto ponasanje kao SURVEY/IDEA - resurs obavezan, bez URL.
AKCIJA_IDEA_CYCLE = "IDEA_CYCLE"

AKCIJA_TIPOVI = (AKCIJA_NONE, AKCIJA_SURVEY, AKCIJA_IDEA, AKCIJA_URL, AKCIJA_IDEA_CYCLE)
# Tipovi koji koriste RESURS_ID (interni entitet) odnosno spoljni URL.
AKCIJE_SA_RESURSOM = (AKCIJA_SURVEY, AKCIJA_IDEA, AKCIJA_IDEA_CYCLE)
